...
<?php else : ?>
	...
	<?php endif; ?> 
			...
			<?php if ( ! get_field( 'hide_post_author_box', 'option' ) && get_option( 'permalink_structure' ) && get_the_author_meta( 'description' ) ) : ?>
				<div class="post-author">
					...
					<?php echo esc_html_e( 'Posted by', 'king' ); ?><a class="post-author-name" href="<?php echo esc_url( site_url() . '/' . $GLOBALS['king_account'] . '/' . $author ); ?>"><?php  echo esc_attr( $author ); ?></a>
