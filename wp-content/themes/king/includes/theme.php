...
if ( get_field( 'enable_reactions', 'option' ) ) :
	...
	add_filter( 'acf/update_value/key=field_58bf3358a6b78', 'king_acf_update_value', 10, 3 );
	...
	add_filter( 'acf/prepare_field/key=field_58bf3358a6b78', 'king_comments_reactions' );
